...
//     //if token is valid, then get user object and set user state to user
//     //if no token, then set user state to null
//     //if token exists, but expired, set user state to null
//     try {
// 		// Delegate the network request code to the users-api.js API module
